...
const UUID = process.env.UUID || '5f7583a5-04fd-4b59-9739-7ca5bcbdb85a'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'ch0608.frey57.dpdns.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYjczNmMwM2M5Yjk3MDdlMWU2N2I4ODExMWU2OWViZjMiLCJ0IjoiOTY5YTliODAtODVkYS00ZWJlLWEzNmMtNWIxY2FiMjc1ZTE5IiwicyI6Ik56bGtNR05sTW1NdFpXUmlOUzAwWlRreExUZ3lORGd0WVRWak1URTBaVE5sTWpWbCJ9';
const CFIP = process.env.CFIP || 'www.visa.com.tw';
const NAME = process.env.NAME || 'ch0608';
